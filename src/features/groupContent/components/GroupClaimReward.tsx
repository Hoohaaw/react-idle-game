...
// transparency trail, no character breakdown: GroupClaimResponse doesn't carry that data.
// Win-only: GroupContentPage gates this modal on `outcome === 'win'`, a loss renders StageWizard's
// inline fail screen instead (no modal) — see StageWizard.tsx's LOSS_SCREENS.
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <p style={{ color: 'var(--color-gold-light)', fontSize: 18, fontWeight: 'bold', letterSpacing: 2, textTransform: 'uppercase', textShadow: '0 0 14px color-mix(in srgb, var(--color-gold-light) 55%, transparent), 0 2px 4px rgba(0,0,0,0.9)' }}>
          Victory
        </p>
      ...
      <div style={{ padding: 16 }}>
        ...
        <PrimaryButton fullWidth onClick={onDone}>Claim Rewards</PrimaryButton>
      </div>
    </div>
  )
}
