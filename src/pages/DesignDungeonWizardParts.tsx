...
import type { WizardLoot, WizardChar } from './DesignDungeonWizardSamples'

// Card/tile subcomponents for the dungeon/raid stage-wizard redesign prototype (/design only).
...
export function LootCard({ item }: { item: WizardLoot }) {
  return (
    <div className="atom-heavy" style={{
...
export function PartyTile({ char, selected, disabled, onToggle }: { char: WizardChar; selected: boolean; disabled?: boolean; onToggle: () => void }) {
