# Balance sweep — 2026-07-11 (schools)

1,584,000 fights (3168 cells × 500 seeds) in 13.6s. Naked baselines (no gear, no blessings). Constants: ARMOR_K=100, TANK_THREAT_MULT=4, TANK_THREAT_STAT_RATE=3, HEALER_HEAL_THRESHOLD=0.7, DODGE_CAP=25, SPEED_DR_K=30, MARGIN_MAX=0.5, LEVEL_BONUS=0.004, BASE_INTERVAL=3, REF_SPEED=10.
