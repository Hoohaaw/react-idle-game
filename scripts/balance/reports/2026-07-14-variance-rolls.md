# Balance sweep — 2026-07-14 (variance-rolls)

633,600 fights (3168 cells × 200 seeds) in 4.8s. Naked baselines (no gear, no blessings). Constants: ARMOR_K=100, TANK_THREAT_MULT=4, TANK_THREAT_STAT_RATE=3, HEALER_HEAL_THRESHOLD=0.7, DODGE_CAP=25, SPEED_DR_K=30, MARGIN_MAX=0.5, LEVEL_BONUS=0.004, BASE_INTERVAL=3, REF_SPEED=10, PARTY_POWER_ROLL=0.1, ENEMY_STAT_ROLL=0.12.
...
- **Timeout-heavy** (20 cells >30% timeouts): trio-no-tank L10 T3 boss@180s (44%), trio-no-tank L10 T3 boss@300s (43%), trio-no-tank L20 T4 boss@180s (56%), trio-no-tank L20 T4 boss@300s (63%), trio-no-tank L50 T5 boss@180s (70%), ….
...
- **Cliff** trio-core L5 boss: T2 100% → T3 1%.
...
- **Cliff** trio-core L50 boss: T6 92% → T7 0%.
...
- **Cliff** trio-double-dps L35 boss: T4 100% → T5 10%.
...
- **Cliff** trio-casters L50 boss: T4 100% → T5 1%.
...
- **Cliff** trio-double-tank L20 boss: T4 99% → T5 0%.
...
- **Cliff** trio-utility L5 boss: T1 98% → T2 0%.
...
- **Cliff** trio-gatherers L20 boss: T2 100% → T3 5%.
...
51/1584 cells (3%) — solo: 16, pack: 12, boss: 23.
...
| comp \ tier | 1 | 2 | 3 | 4 | 5 | 6 | 7 | 8 |
|---|---|---|---|---|---|---|---|---|
| trio-core | 100% m98% | 43% m77% | 0 | 0 | 0 | 0 | 0 | 0 |
| trio-double-dps | 100% m50% | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
| trio-no-tank | 100% m96% | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
| trio-casters | 91% m69% | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
| trio-double-tank | 100% m100% | 18% m93% | 0 | 0 | 0 | 0 | 0 | 0 |
| trio-utility | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
| trio-gatherers | 20% m16% | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
| duo-tank-heal | 99% m98% | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
| solo-tank | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
| solo-dps | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
| solo-crit | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
...
| comp \ tier | 1 | 2 | 3 | 4 | 5 | 6 | 7 | 8 |
|---|---|---|---|---|---|---|---|---|
| trio-core | 100% m97% | 100% m95% | 1% m78% | 0 | 0 | 0 | 0 | 0 |
| trio-double-dps | 100% m82% | 100% m36% | 0 | 0 | 0 | 0 | 0 | 0 |
| trio-no-tank | 100% m98% | 100% m89% | 0 | 0 | 0 | 0 | 0 | 0 |
| trio-casters | 100% m89% | 51% m57% | 0 | 0 | 0 | 0 | 0 | 0 |
| trio-double-tank | 100% m98% | 100% m99% | 0 | 0 | 0 | 0 | 0 | 0 |
| trio-utility | 98% m45% | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
| trio-gatherers | 100% m64% | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
| duo-tank-heal | 100% m99% | 57% m99% | 0 | 0 | 0 | 0 | 0 | 0 |
| solo-tank | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
| solo-dps | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
| solo-crit | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
...
| comp \ tier | 1 | 2 | 3 | 4 | 5 | 6 | 7 | 8 |
|---|---|---|---|---|---|---|---|---|
| trio-core | 100% m92% | 100% m97% | 100% m93% | 0 | 0 | 0 | 0 | 0 |
| trio-double-dps | 100% m93% | 100% m75% | 26% m13% | 0 | 0 | 0 | 0 | 0 |
| trio-no-tank | 100% m93% | 100% m95% | 56% m59% | 0 | 0 | 0 | 0 | 0 |
| trio-casters | 100% m86% | 100% m87% | 1% m36% | 0 | 0 | 0 | 0 | 0 |
| trio-double-tank | 100% m92% | 100% m99% | 100% m97% | 0 | 0 | 0 | 0 | 0 |
| trio-utility | 100% m76% | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
| trio-gatherers | 100% m84% | 67% m31% | 0 | 0 | 0 | 0 | 0 | 0 |
| duo-tank-heal | 100% m99% | 100% m97% | 0 | 0 | 0 | 0 | 0 | 0 |
| solo-tank | 83% m21% | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
...
| comp \ tier | 1 | 2 | 3 | 4 | 5 | 6 | 7 | 8 |
|---|---|---|---|---|---|---|---|---|
| trio-core | 100% m97% | 100% m92% | 100% m98% | 100% m94% | 0 | 0 | 0 | 0 |
| trio-double-dps | 100% m98% | 100% m94% | 100% m76% | 31% m22% | 0 | 0 | 0 | 0 |
| trio-no-tank | 100% m96% | 100% m97% | 100% m95% | 6% m65% | 0 | 0 | 0 | 0 |
| trio-casters | 100% m93% | 100% m86% | 100% m78% | 0 | 0 | 0 | 0 | 0 |
| trio-double-tank | 100% m97% | 100% m94% | 100% m100% | 99% m97% | 0 | 0 | 0 | 0 |
| trio-utility | 100% m91% | 100% m69% | 0 | 0 | 0 | 0 | 0 | 0 |
| trio-gatherers | 100% m96% | 100% m81% | 5% m28% | 0 | 0 | 0 | 0 | 0 |
| duo-tank-heal | 100% m90% | 100% m99% | 100% m97% | 0 | 0 | 0 | 0 | 0 |
| solo-tank | 100% m84% | 54% m17% | 0 | 0 | 0 | 0 | 0 | 0 |
...
| comp \ tier | 1 | 2 | 3 | 4 | 5 | 6 | 7 | 8 |
|---|---|---|---|---|---|---|---|---|
| trio-core | 100% m99% | 100% m97% | 100% m90% | 100% m97% | 100% m93% | 0 | 0 | 0 |
| trio-double-dps | 100% m99% | 100% m98% | 100% m94% | 100% m76% | 10% m17% | 0 | 0 | 0 |
| trio-no-tank | 100% m98% | 100% m94% | 100% m97% | 100% m77% | 2% m68% | 0 | 0 | 0 |
| trio-casters | 100% m96% | 100% m92% | 100% m83% | 100% m50% | 0 | 0 | 0 | 0 |
| trio-double-tank | 100% m100% | 100% m98% | 100% m94% | 100% m100% | 30% m100% | 0 | 0 | 0 |
| trio-utility | 100% m97% | 100% m88% | 83% m42% | 0 | 0 | 0 | 0 | 0 |
| trio-gatherers | 100% m97% | 100% m94% | 100% m76% | 0 | 0 | 0 | 0 | 0 |
| duo-tank-heal | 100% m96% | 100% m89% | 100% m100% | 53% m100% | 0 | 0 | 0 | 0 |
| solo-tank | 100% m100% | 100% m84% | 14% m15% | 0 | 0 | 0 | 0 | 0 |
...
| comp \ tier | 1 | 2 | 3 | 4 | 5 | 6 | 7 | 8 |
|---|---|---|---|---|---|---|---|---|
| trio-core | 100% m99% | 100% m98% | 100% m96% | 100% m97% | 100% m97% | 92% m95% | 0 | 0 |
| trio-double-dps | 100% m99% | 100% m99% | 100% m97% | 100% m89% | 100% m66% | 0 | 0 | 0 |
| trio-no-tank | 100% m98% | 100% m97% | 100% m92% | 100% m92% | 31% m60% | 0 | 0 | 0 |
| trio-casters | 100% m98% | 100% m94% | 100% m92% | 100% m80% | 1% m45% | 0 | 0 | 0 |
| trio-double-tank | 100% m99% | 100% m99% | 100% m96% | 100% m99% | 100% m98% | 0 | 0 | 0 |
| trio-utility | 100% m97% | 100% m95% | 100% m76% | 42% m23% | 0 | 0 | 0 | 0 |
| trio-gatherers | 100% m99% | 100% m96% | 100% m86% | 90% m41% | 0 | 0 | 0 | 0 |
| duo-tank-heal | 100% m98% | 100% m94% | 100% m91% | 100% m98% | 0 | 0 | 0 | 0 |
| solo-tank | 100% m100% | 100% m100% | 100% m71% | 0 | 0 | 0 | 0 | 0 |
