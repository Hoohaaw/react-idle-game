...
- [x] **Deploy the Sanity Studio schema** (2026-09-22) — ran `cd studio && npm run schema:deploy`;
  `recipeDef`/`reagentLine`/`rarityWeight` (plus the `proficiency`/`proficiencyTags` fields added by
  ADR-0059) now show up for authoring in the hosted Studio. Verified via `npx sanity schema list`.
